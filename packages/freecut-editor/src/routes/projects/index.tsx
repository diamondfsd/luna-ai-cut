...
import { Plus, Upload, FolderOpen, File, BookOpen } from 'lucide-react'
...
import { Progress } from '@freecut/components/ui/progress'
import { useProjectStore } from '@freecut/features/projects/stores/project-store'
import { useProjectActions } from '@freecut/features/projects/hooks/use-project-actions'
import {
  useProjects,
  useProjectsLoading,
  useProjectsError,
} from '@freecut/features/projects/hooks/use-project-selectors'
import { cleanupBlobUrls } from '@freecut/features/media-library/utils/media-resolver'
...
import type { ImportProgress } from '@freecut/features/project-bundle/types/bundle'
import { BUNDLE_EXTENSION } from '@freecut/features/project-bundle/types/bundle'
  ...
  const handleStartImport = async () => {
    ...
    try {
      ...
      const { importProjectBundle } =
        await import('@freecut/features/project-bundle/services/bundle-import-service')
