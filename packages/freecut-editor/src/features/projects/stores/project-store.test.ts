...
vi.mock('@freecut/infrastructure/storage', () => storageMocks)

vi.mock('@freecut/features/projects/deps/media-library-contract', () => ({
...
vi.mock('@freecut/features/projects/deps/settings-contract', () => ({
  useSettingsStore: {
