...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@freecut/components/ui/dialog'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import {
  ...
  importWaveformCache,
} from '@freecut/features/editor/deps/timeline-cache'
import { clearPreviewAudioCache } from '@freecut/features/editor/deps/composition-runtime'
import { CAPTION_STYLE_PRESETS } from '@freecut/shared/typography/caption-style-presets'
...
async function clearProjectCaches(
  ...
  const [
    ...
    import('@freecut/infrastructure/storage'),
    import('@freecut/features/editor/deps/composition-runtime'),
    importGifFrameCache(),
    importFilmstripCache(),
    importWaveformCache(),
  ])
