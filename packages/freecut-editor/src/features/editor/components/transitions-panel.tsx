...
import { resolveTransitionTargetFromSelection } from '@freecut/features/editor/deps/timeline-utils'
import type {
  WipeDirection,
  SlideDirection,
  FlipDirection,
...
import { TRANSITION_DRAG_MIME, useTransitionDragStore } from '@freecut/shared/state/transition-drag'
import {
  TRANSITION_ICON_MAP,
