...
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from '@freecut/components/ui/resizable'
...
} from '@freecut/features/editor/deps/timeline-ui'
import { toast } from 'sonner'
import { useEditorHotkeys } from '@freecut/features/editor/hooks/use-editor-hotkeys'
import { useAutoSave } from '../hooks/use-auto-save'
import {
  useTimelineShortcuts,
  useTransitionBreakageNotifications,
} from '@freecut/features/editor/deps/timeline-hooks'
import { initTransitionChainSubscription } from '@freecut/features/editor/deps/timeline-subscriptions'
import { useTimelineStore } from '@freecut/features/editor/deps/timeline-store'
import { importBundleExportDialog } from '@freecut/features/editor/deps/project-bundle'
...
import { useMaskEditorStore } from '@freecut/features/editor/deps/preview'
import { usePlaybackStore } from '@freecut/shared/state/playback'
import { useEditorStore } from '@freecut/shared/state/editor'
import { clearPreviewAudioCache } from '@freecut/features/editor/deps/composition-runtime'
...
import {
  ...
  RenderQueueRunner,
  useRenderQueueStore,
} from '@freecut/features/editor/deps/export-contract'
import { getEditorLayout, getEditorLayoutCssVars } from '@freecut/config/editor-layout'
import { EDITOR_WORKSPACE_TIMELINE_SIZE, type EditorWorkspaceId } from '@freecut/config/editor-workspaces'
import {
...
const LazyClearKeyframesDialog = lazy(() =>
  import('@freecut/features/editor/components/clear-keyframes-dialog').then((module) => ({
    default: module.ClearKeyframesDialog,
  })),
)
const LazyTtsGenerateDialog = lazy(() =>
  import('@freecut/features/editor/components/tts-generate-dialog').then((module) => ({
    default: module.TtsGenerateDialog,
  })),
)
const LazyProjectMediaMatchDialog = lazy(() =>
  import('@freecut/features/editor/components/project-media-match-dialog').then((module) => ({
...
export const LoadedEditor = memo(function LoadedEditor({
  ...
  useEffect(() => {
    const id = requestIdleCallback(() => {
      ...
      void import('@freecut/features/editor/deps/effects-contract')
