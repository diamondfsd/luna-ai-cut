...
} from '@freecut/features/editor/deps/timeline-test-helpers-contract'
import {
...
import { useMediaLibraryStore } from '@freecut/features/editor/deps/media-library-contract'
...
import {
  ...
  KEYFRAME_EDGE_INSET,
} from '@freecut/features/editor/deps/timeline-motion-contract'

const perfMarkMocks = vi.hoisted(() => ({ mark: vi.fn() }))

vi.mock('@freecut/shared/logging/perf-marks', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@freecut/shared/logging/perf-marks')>()
  return { ...actual, perfMarkRender: perfMarkMocks.mark }
})

vi.mock('@freecut/features/editor/deps/media-library-contract', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('@freecut/features/editor/deps/media-library-contract')>()
