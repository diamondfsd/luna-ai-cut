...
import { useMaskEditorStore, useItemsStore } from '@freecut/features/editor/deps/preview'
import { useProjectStore } from '@freecut/features/editor/deps/projects'
import { useEditorStore } from '@freecut/shared/state/editor'

vi.mock('@freecut/features/editor/deps/preview', async () => {
  const actual = await vi.importActual<typeof import('@freecut/features/editor/deps/preview')>(
    '@freecut/features/editor/deps/preview',
  )
