...
import { importWaveformCache } from '@freecut/features/editor/deps/timeline-cache'
import { useGizmoStore, useThrottledFrame } from '@freecut/features/editor/deps/preview'
import { importMediaLibraryService } from '@freecut/features/editor/deps/media-library'
import { getResolvedPlaybackFrame, usePlaybackStore } from '@freecut/shared/state/playback'
import {
  getAudioSkimMeterLevel,
  getAudioSkimMeterVersion,
  subscribeAudioSkimMeterLevel,
} from '@freecut/shared/state/audio-skim-meter'
import { usePreviewBridgeStore } from '@freecut/shared/state/preview-bridge'
import { useEditorStore } from '@freecut/shared/state/editor/store'
...
import { FloatingPanel } from '@freecut/components/ui/floating-panel'
import { WindowPortal } from '@freecut/components/ui/window-portal'
...
import { getSparseAudioEqSettings } from '@freecut/shared/utils/audio-eq'
import { type AudioEqSettings } from '@freecut/types/audio'
import { clearMixerLiveGainLayer, setMixerLiveGainLayer } from '@freecut/shared/state/mixer-live-gain'
