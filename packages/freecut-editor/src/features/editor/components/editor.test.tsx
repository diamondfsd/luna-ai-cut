...
vi.mock('@freecut/shared/logging/logger', () => ({
  createLogger: () => ({
    debug: vi.fn(),
    error: vi.fn(),
    info: vi.fn(),
...
vi.mock('@freecut/components/ui/resizable', () => ({
  ResizablePanelGroup: ({
    children,
    ...props
  }: {
...
vi.mock('@freecut/app/error-boundary', () => ({
...
vi.mock('@freecut/features/editor/hooks/use-editor-hotkeys', () => ({
...
vi.mock('@freecut/features/editor/deps/timeline-hooks', () => ({
  useTimelineShortcuts: vi.fn(),
  useTransitionBreakageNotifications: vi.fn(),
}))

vi.mock('@freecut/features/editor/deps/timeline-subscriptions', () => ({
...
vi.mock('@freecut/features/editor/deps/project-bundle', () => ({
  importBundleExportDialog: mocks.importBundleExportDialog,
}))

vi.mock('@freecut/features/editor/deps/media-library', () => {
...
vi.mock('@freecut/features/editor/deps/settings', () => ({
  useSettingsStore: (
...
vi.mock('@freecut/features/editor/deps/preview', () => ({
...
vi.mock('@freecut/shared/state/editor', () => ({
  useEditorStore: (
    selector: (state: {
...
vi.mock('@freecut/features/editor/deps/composition-runtime', () => ({
...
vi.mock('@freecut/features/editor/deps/export-contract', () => ({
...
vi.mock('@freecut/config/editor-layout', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@freecut/config/editor-layout')>()
  const layout = {
...
vi.mock('@freecut/features/projects/services/project-upgrade-service', () => ({
  createProjectUpgradeBackup: mocks.createProjectUpgradeBackup,
}))

vi.mock('@freecut/features/projects/utils/project-helpers', () => ({
