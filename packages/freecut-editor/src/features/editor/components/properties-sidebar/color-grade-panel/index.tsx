...
import { useItemsStore } from '@freecut/features/editor/deps/timeline-store'
import { KeyframeGraphPanel } from '@freecut/features/editor/deps/timeline-keyframe-ui'
import { addAdjustmentLayer } from '@freecut/features/editor/utils/add-adjustment-layer'
import type { TimelineItem } from '@freecut/types/timeline'

const LazyColorGradeSection = lazy(() =>
  import('@freecut/features/editor/deps/effects-contract').then((module) => ({
