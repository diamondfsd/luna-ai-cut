...
import type { TextItem, TextSpan, TimelineItem } from '@freecut/types/timeline'
...
import { useGizmoStore, type ItemPropertiesPreview } from '@freecut/features/editor/deps/preview'
import { KeyframeToggle } from '@freecut/features/editor/deps/keyframes'
...
import { FONT_CATALOG, FONT_WEIGHT_MAP } from '@freecut/shared/typography/fonts'
import {
...
import {
  ...
  getTextItemSpans,
} from '@freecut/shared/utils/text-item-spans'
import {
  ...
  type TextLayoutMode,
} from '@freecut/shared/utils/text-layout-drafts'
