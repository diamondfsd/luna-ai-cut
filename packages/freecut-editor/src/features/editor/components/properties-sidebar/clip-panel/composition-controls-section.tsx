...
import type { CompositionControlDefinition } from '@freecut/types/composition-controls'
import type { CompositionItem, TimelineItem } from '@freecut/types/timeline'
import { useCompositionsStore, useTimelineStore } from '@freecut/features/editor/deps/timeline-store'
import { getCompositionControlSourceValue } from '@freecut/shared/utils/composition-controls'
