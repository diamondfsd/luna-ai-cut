...
import type { LottieItem, TimelineItem } from '@freecut/types/timeline'
import { useTimelineStore } from '@freecut/features/editor/deps/timeline-store'
import { extractLottieTextLayers, type LottieTextLayer } from '@freecut/infrastructure/lottie/lottie-text'
import {
  extractLottieColorLayers,
  type LottieColorLayer,
} from '@freecut/infrastructure/lottie/lottie-color'
import { extractLottieValueSlots, type LottieValueSlot } from '@freecut/infrastructure/lottie/lottie-slots'
import {
  ...
  type LottieMarker,
} from '@freecut/infrastructure/lottie/lottie-metadata'
import { resolveMediaUrl } from '@freecut/features/editor/deps/media-library'
