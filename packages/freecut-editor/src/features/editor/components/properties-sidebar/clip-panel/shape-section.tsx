...
import type { ShapeItem, ShapeType, TimelineItem } from '@freecut/types/timeline'
import { useKeyframesStore, useTimelineStore } from '@freecut/features/editor/deps/timeline-store'
import { useGizmoStore, useMaskEditorStore } from '@freecut/features/editor/deps/preview'
import { hasPathVertexKeyframes } from '@freecut/features/editor/deps/keyframes'
import {
  PropertySection,
  PropertyRow,
  NumberInput,
...
import { reversePathVertices, rotateClosedPathStart } from '@freecut/shared/graphics/shapes/bezier-path'
import {
