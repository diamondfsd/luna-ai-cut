...
import type { TransformProperties, CanvasSettings } from '@freecut/types/transform'
import { useGizmoStore, useThrottledFrame } from '@freecut/features/editor/deps/preview'
import { useKeyframesStore, useTimelineStore } from '@freecut/features/editor/deps/timeline-store'
import { resolveTransform, getSourceDimensions } from '@freecut/features/editor/deps/composition-runtime'
import {
