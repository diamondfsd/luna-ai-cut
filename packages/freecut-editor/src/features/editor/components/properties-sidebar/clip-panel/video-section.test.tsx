...
import type { CompositionItem, VideoItem } from '@freecut/types/timeline'
...
vi.mock('@freecut/features/editor/deps/preview', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@freecut/features/editor/deps/preview')>()
  return { ...actual, useThrottledFrame: () => 0 }
})

vi.mock('@freecut/features/editor/deps/keyframes', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@freecut/features/editor/deps/keyframes')>()
  return {
    ...actual,
