import type { BlockedFrameRange } from '@freecut/features/keyframes/utils/transition-region'
import {
  clampFrame,
  clampToAvoidBlockedRanges,
} from '@freecut/features/keyframes/components/dopesheet-editor/frame-utils'
