...
import type { MotionModifier } from '@freecut/types/motion'
import type { TextMotionSlot } from '@freecut/types/text-motion'
import type { TextMotionTimelineBand } from '@freecut/shared/timeline/text-motion-timeline'
import {
...
import { TimelinePreviewScrubberVisual } from '@freecut/shared/ui/timeline-preview-scrubber-visual'
...
} from '@freecut/shared/timeline/live-scroll-sync'
import {
...
import { useMotionPickWhipDrag } from '@freecut/shared/hooks/use-pick-whip-drag'
import { PickWhipOverlay } from '@freecut/shared/ui/pick-whip-overlay'
import {
  evaluatePropertyExpression,
  isExpressionValueCompatible,
  type ExpressionValue,
} from '@freecut/features/keyframes/utils/property-expression'
import {
...
} from '@freecut/features/keyframes/deps/timeline-playhead'
import {
  DRAG_THRESHOLD,
...
} from '@freecut/features/keyframes/property-value-ranges'
import {
  colorStringToKeyframeValue,
  keyframeValueToHexColor,
} from '@freecut/features/keyframes/utils/color-keyframes'
import { constrainSelectedKeyframeDelta } from '@freecut/features/keyframes/utils/frame-move-constraints'
...
} from '@freecut/features/keyframes/utils/property-i18n'
