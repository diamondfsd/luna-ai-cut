...
import { useThrottledFrame } from '@freecut/features/keyframes/deps/preview-contract'
import type { AnimatableProperty, ItemKeyframes, Keyframe } from '@freecut/types/keyframe'
import type { TimelineItem } from '@freecut/types/timeline'
import type { Transition } from '@freecut/types/transition'
import { Tooltip, TooltipContent, TooltipTrigger } from '@freecut/components/ui/tooltip'
