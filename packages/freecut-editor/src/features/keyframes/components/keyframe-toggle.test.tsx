...
import {
  ...
  useKeyframesStore,
  useTransitionsStore,
} from '@freecut/features/keyframes/deps/timeline'
...
vi.mock('@freecut/features/keyframes/deps/preview-contract', () => ({
  useThrottledFrame: () => 10,
}))

vi.mock('@freecut/features/keyframes/deps/timeline', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@freecut/features/keyframes/deps/timeline')>()
  return {
    ...actual,
    useTimelineStore: (
      selector: (state: {
