...
import type { AudioPulseModulation } from '@freecut/types/effects'
import type { TimelineItem } from '@freecut/types/timeline'
import type { MotionAnimationLayer, MotionModifier } from '@freecut/types/motion'
import {
...
import { clamp } from '@freecut/shared/utils/math'
