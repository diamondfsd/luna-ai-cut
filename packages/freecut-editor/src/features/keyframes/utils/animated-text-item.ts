import type { BuiltInAnimatableProperty, ItemKeyframes } from '@freecut/types/keyframe'
import type { TextItem } from '@freecut/types/timeline'
import type { CanvasSettings } from '@freecut/types/transform'
import { applyTextStylePresetToItem } from '@freecut/shared/typography/text-style-presets'
