...
import type { ScrubbingCache } from '@freecut/features/export/deps/preview'
import type { CachedGifFrames } from '@freecut/features/export/deps/timeline-gif-cache'
import type { LottieExportProvider } from '@freecut/infrastructure/lottie/lottie-frame-provider'
...
import type { PreviewPathVerticesOverride } from '@freecut/features/export/deps/composition-runtime'
import type { GpuTexturePool } from '@freecut/infrastructure/gpu-compositor'
import type {
  MediaBlendPipeline,
  GpuMediaRect,
  GpuMediaRenderParams,
  MediaRenderPipeline,
} from '@freecut/infrastructure/gpu-media'
import type { ShapeRenderPipeline } from '@freecut/infrastructure/gpu-shapes'
import type { GlyphAtlasTextPipeline } from '@freecut/infrastructure/gpu-text'
...
} from '@freecut/types/composition-controls'
...
export interface ItemRenderContext {
  ...
  gpuPipeline?: import('@freecut/infrastructure/gpu-effects').EffectsPipeline | null

  // GPU transition pipeline (lazily initialized, shares device with gpuPipeline)
  gpuTransitionPipeline?: import('@freecut/infrastructure/gpu-transitions').TransitionPipeline | null
