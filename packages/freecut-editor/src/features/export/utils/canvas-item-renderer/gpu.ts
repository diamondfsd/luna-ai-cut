...
import type { GpuMediaRect, GpuMediaRenderParams } from '@freecut/infrastructure/gpu-media'
import { MAX_GPU_SHAPE_PATH_VERTICES } from '@freecut/infrastructure/gpu-shapes'
...
import { resolveShapeLinearGradient } from '@freecut/shared/graphics/shapes/linear-gradient'
