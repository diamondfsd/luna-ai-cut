...
import type { CompositionItem, ShapeItem, TimelineItem } from '@freecut/types/timeline'
import type { ItemKeyframes } from '@freecut/types/keyframe'
import { doesMaskAffectTrack } from '@freecut/shared/utils/mask-scope'
import { hasMediaCrop } from '@freecut/shared/utils/media-crop'
import { applyPreviewPathVerticesToShape } from '@freecut/features/export/deps/composition-runtime'
import { hasCornerPin } from '@freecut/features/export/deps/composition-runtime'
