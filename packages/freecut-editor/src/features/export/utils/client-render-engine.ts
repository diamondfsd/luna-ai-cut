...
} from '@freecut/infrastructure/lottie/lottie-frame-provider'
import { resolveLottieRenderSpec } from '@freecut/infrastructure/lottie/lottie-text'
...
import { resolveMediaUrl, resolveProxyUrl } from '@freecut/features/export/deps/media-library'
import { VideoSourcePool } from '@freecut/features/export/deps/player-contract'
import { recordPreviewCompositionRender } from '@freecut/shared/logging/preview-scrub-performance'
import { recordPreviewCanvasPool } from '@freecut/shared/logging/preview-scrub-performance'
...
import { type CachedGifFrames, gifFrameCache } from '@freecut/features/export/deps/timeline-gif-cache'
...
import { getCompositeOperation } from '@freecut/types/blend-mode-css'
import {
  useCompositionsStore,
  type SubComposition,
} from '@freecut/features/export/deps/timeline-compositions'
import { doesMaskAffectTrack } from '@freecut/shared/utils/mask-scope'
...
export async function createCompositionRenderer(
  ...
  if (renderMode === 'preview' || isComparisonMode) {
    try {
      ...
      } = await import('@freecut/features/export/deps/preview-contract')
