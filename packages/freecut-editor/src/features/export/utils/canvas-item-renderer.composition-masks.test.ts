...
import { LottieExportProvider } from '@freecut/infrastructure/lottie/lottie-frame-provider'
import type { CompositionItem, ImageItem, ShapeItem } from '@freecut/types/timeline'
...
vi.mock('@freecut/features/export/deps/composition-runtime', async () => {
  const actual = await vi.importActual<typeof import('@freecut/features/export/deps/composition-runtime')>(
    '@freecut/features/export/deps/composition-runtime',
  )
  return {
    ...actual,
