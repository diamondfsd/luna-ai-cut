...
import type { ImageItem, TextItem, TimelineItem, VideoItem } from '@freecut/types/timeline'
...
import { resolveAnimatedColorEffects } from '@freecut/features/export/deps/keyframes'
...
vi.mock('@freecut/shared/utils/media-crop', () => ({ hasMediaCrop: vi.fn() }))
vi.mock('@freecut/features/export/deps/keyframes', () => ({ resolveAnimatedColorEffects: vi.fn() }))
