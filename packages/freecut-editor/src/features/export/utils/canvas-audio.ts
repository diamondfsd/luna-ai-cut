...
import type { AudioEqSettings, ResolvedAudioEqSettings } from '@freecut/types/audio'
import type { Keyframe as VolumeKeyframe } from '@freecut/types/keyframe'
...
} from '@freecut/features/export/deps/timeline-frame'
import {
  useCompositionsStore,
  collectReachableCompositionIdsFromTracks,
} from '@freecut/features/export/deps/timeline-compositions'
import { getPropertyKeyframes, interpolatePropertyValue } from '@freecut/features/export/deps/keyframes'
import { blobUrlManager } from '@freecut/infrastructure/browser/blob-url-manager'
import { getMediaAudioCodecById, resolveMediaUrl } from '@freecut/features/export/deps/media-library'
import { ensureAc3DecoderRegistered, isAc3AudioCodec } from '@freecut/shared/utils/ac3-decoder'
import {
...
} from '@freecut/shared/utils/audio-fade-curve'
import { createMediabunnyInputSource } from '@freecut/infrastructure/browser/mediabunny-input-source'
import {
...
async function applySpeedAndPitch(
  ...
  try {
    const timeStretch = await import('@freecut/infrastructure/audio/time-stretch')
