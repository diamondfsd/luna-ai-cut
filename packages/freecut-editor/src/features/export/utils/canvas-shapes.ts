...
import { getShapePath, rotatePath } from '@freecut/features/export/deps/composition-runtime'
...
import { getTaperStrokeSegments, hasActiveTaper } from '@freecut/shared/graphics/shapes/taper-path'
import {
