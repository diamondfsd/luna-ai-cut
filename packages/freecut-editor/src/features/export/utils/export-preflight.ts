import type { CompositionInputProps, ExtendedExportSettings } from '@freecut/types/export'
import type { TimelineTrack } from '@freecut/types/timeline'
import { framesToSeconds } from '@freecut/shared/utils/time-utils'
import { isGifUrl, isWebpUrl } from '@freecut/shared/utils/media-utils'
import { ensureAudioEncoderSupport } from '@freecut/shared/media/audio-encoder-support'
