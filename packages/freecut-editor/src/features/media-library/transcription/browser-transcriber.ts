...
import type { MediaTranscriptQuantization } from '@freecut/types/storage'
import { localInferenceRuntimeRegistry } from '@freecut/shared/state/local-inference'
import { LOCAL_INFERENCE_UNLOADED_MESSAGE } from '@freecut/shared/state/local-inference'
import {
...
import { DEFAULT_WHISPER_MODEL } from '@freecut/shared/utils/whisper-settings'
