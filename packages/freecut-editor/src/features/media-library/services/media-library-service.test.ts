...
vi.mock('@freecut/infrastructure/storage', () => indexedDbMocks)
...
vi.mock('@freecut/runtime/composition-runtime/utils/audio-codec-detection', () => ({
  needsCustomAudioDecoder: compositionRuntimeMocks.needsCustomAudioDecoder,
}))

vi.mock('@freecut/runtime/composition-runtime/utils/audio-decode-cache', () => ({
...
vi.mock('@freecut/runtime/composition-runtime/utils/preview-audio-conform', () => ({
  deletePreviewAudioConform: previewAudioConformMocks.deletePreviewAudioConform,
}))

vi.mock('@freecut/features/media-library/deps/timeline-services', () => ({
