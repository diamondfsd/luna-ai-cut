import type { MediaAttribution, MediaMetadata, ThumbnailData } from '@freecut/types/storage'
...
import {
  ...
  readMediaSource,
  writeMediaSource,
} from '@freecut/features/media-library/deps/storage'
import {
  importFilmstripCache,
  importGifFrameCache,
  importWaveformCache,
} from '@freecut/features/media-library/deps/timeline-services'
...
import { parseLottieFileBytes } from '@freecut/infrastructure/lottie/lottie-metadata'
...
} from '@freecut/features/media-library/deps/composition-runtime'
    ...
    try {
      ...
      try {
        const { renderLottieThumbnail } =
          await import('@freecut/infrastructure/lottie/lottie-frame-provider')
