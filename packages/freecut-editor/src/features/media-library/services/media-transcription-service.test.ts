...
vi.mock('@freecut/features/media-library/deps/projects', () => ({
  useProjectStore: {
    getState: useProjectStoreGetStateMock,
  },
}))

vi.mock('@freecut/features/media-library/deps/timeline-stores', () => ({
...
vi.mock('@freecut/features/media-library/deps/settings-contract', () => ({
  useSettingsStore: {
    getState: () => ({
...
vi.mock('@freecut/features/media-library/deps/composition-runtime-contract', () => ({
