...
vi.mock('@freecut/shared/utils/whisper-settings', () => ({
...
vi.mock('@freecut/components/ui/button', () => ({
  Button: ({
    children,
    onClick,
    disabled,
...
vi.mock('@freecut/components/ui/label', () => ({
  Label: ({ children, htmlFor }: { children: ReactNode; htmlFor?: string }) => (
    <label htmlFor={htmlFor}>{children}</label>
  ),
}))

vi.mock('@freecut/components/ui/combobox', () => ({
  Combobox: ({
    id,
    value,
    onValueChange,
...
vi.mock('@freecut/components/ui/select', () => ({
  Select: ({
    children,
    value,
    onValueChange,
...
vi.mock('@freecut/components/ui/dialog', async () => {
