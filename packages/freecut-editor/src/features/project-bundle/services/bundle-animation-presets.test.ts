...
import type { AnimationPreset } from '@freecut/infrastructure/storage/workspace-fs/animation-presets'
import { sanitizeAnimationPresets } from '@freecut/infrastructure/storage/workspace-fs/animation-presets'
...
vi.mock('@freecut/features/project-bundle/deps/media-library', () => ({
