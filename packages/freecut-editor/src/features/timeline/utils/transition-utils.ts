...
import type { CanAddTransitionResult, Transition } from '@freecut/types/transition'
import {
  getSourceProperties,
  sourceToTimelineFrames,
  getAvailableSourceFrames,
} from './source-calculations'
import { calculateTransitionPortions } from '@freecut/shared/timeline/transitions/transition-planner'
