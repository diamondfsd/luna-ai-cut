import type { TimelineTrack, TimelineItem, ProjectMarker, VideoItem } from '@freecut/types/timeline'
import type { TransformProperties } from '@freecut/types/transform'
import type { ItemEffect, VisualEffect } from '@freecut/types/effects'
import type {
  Transition,
  TransitionType,
...
import type { AutoKeyframeOperation } from '@freecut/features/timeline/deps/keyframes'
