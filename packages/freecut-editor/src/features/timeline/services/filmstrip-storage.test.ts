...
vi.mock('@freecut/infrastructure/storage/cache-version', () => ({
...
vi.mock('@freecut/infrastructure/storage/workspace-fs/fs-primitives', () => fsMocks)

vi.mock('@freecut/infrastructure/storage/workspace-fs/root', () => ({
  requireWorkspaceRoot: vi.fn(() => 'workspace-root'),
}))

vi.mock('@freecut/infrastructure/storage/workspace-fs/paths', () => ({
