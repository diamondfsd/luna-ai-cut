...
import { useGradeClipboardStore } from '@freecut/shared/state/grade-clipboard'
...
import { PROPERTY_LABELS, type AnimatableProperty } from '@freecut/types/keyframe'
import type { PropertyKeyframes } from '@freecut/types/keyframe'
import {
  getSceneVerificationModelOptions,
  type SceneDetectionMethod,
  type VerificationModel,
} from '@freecut/features/timeline/deps/analysis'
