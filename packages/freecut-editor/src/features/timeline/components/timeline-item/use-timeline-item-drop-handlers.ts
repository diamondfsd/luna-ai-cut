...
import { getMediaDragData } from '@freecut/features/timeline/deps/media-library-resolver'
import {
  TRANSITION_DRAG_MIME,
  useTransitionDragStore,
  type DraggedTransitionDescriptor,
} from '@freecut/shared/state/transition-drag'
...
import { resolveTransitionTargetForEdge } from '@freecut/features/timeline/utils/transition-targets'
import { resolveEffectiveTrackStates } from '@freecut/features/timeline/utils/group-utils'
