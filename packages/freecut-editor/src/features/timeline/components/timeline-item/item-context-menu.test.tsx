...
vi.mock('@freecut/components/ui/context-menu', () => ({
...
vi.mock('@freecut/features/timeline/deps/analysis', () => ({
  getSceneVerificationModelOptions: mockGetSceneVerificationModelOptions,
}))

vi.mock('@freecut/features/timeline/deps/settings', () => ({
  useResolvedHotkeys: () => ({}),
}))

vi.mock('@freecut/config/hotkeys', () => ({
  formatHotkeyBinding: () => '',
}))
