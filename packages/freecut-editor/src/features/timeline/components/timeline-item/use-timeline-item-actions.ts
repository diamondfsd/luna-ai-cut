...
import type { MediaTranscriptModel, MediaTranscriptQuantization } from '@freecut/types/storage'
...
import { saveScenes } from '@freecut/infrastructure/storage/workspace-fs/scenes'
import {
