...
import { MotionBakeConfirmationDialog } from '@freecut/shared/ui/motion-bake-confirmation-dialog'
...
} from '@freecut/features/timeline/deps/keyframes'
import {
  DopesheetEditor,
...
import { usePropertyLinkPickWhip } from '@freecut/features/timeline/hooks/use-property-link-pick-whip'
import { bakeMotionToKeyframes } from '../stores/actions/motion-modifier-actions'
import { resolveTransform, getSourceDimensions } from '@freecut/features/timeline/deps/composition-runtime'
...
import { getTextMotionTimelineBands } from '@freecut/shared/timeline/text-motion-timeline'
...
import { HOTKEY_OPTIONS } from '@freecut/config/hotkeys'
import { useResolvedHotkeys } from '@freecut/features/timeline/deps/settings'
import { getDirectPropertyLinks, isTransformAnimatableProperty } from '@freecut/types/keyframe'
import { buildEffectPropertyResetPlan } from '@freecut/features/timeline/utils/effect-property-reset'
