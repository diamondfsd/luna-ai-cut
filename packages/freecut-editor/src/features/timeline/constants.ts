...
} from '@freecut/shared/timeline/defaults'
import { EDITOR_LAYOUT } from '@freecut/config/editor-layout'
import type { TrackSizePreset } from '@freecut/shared/state/editor'
...
/** Subtitle lanes stay label-only and visually distinct from media lanes. */
export const SUBTITLE_TRACK_HEIGHT = 40
