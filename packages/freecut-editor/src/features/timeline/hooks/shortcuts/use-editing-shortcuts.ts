...
import { canJoinMultipleItems } from '@freecut/features/timeline/utils/clip-utils'
import { canLinkSelection, hasLinkedItems } from '@freecut/features/timeline/utils/linked-items'
import {
  insertFreezeFrame,
  linkItems,
