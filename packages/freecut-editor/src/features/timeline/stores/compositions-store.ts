...
import type { TimelineItem, TimelineTrack, ProjectMarker } from '@freecut/types/timeline'
...
import type { CompositionEditorKind } from '@freecut/types/project'
import type { CompositionControlSchema } from '@freecut/types/composition-controls'
