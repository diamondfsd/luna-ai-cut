...
vi.mock('@freecut/infrastructure/storage', async (importOriginal) => {
...
vi.mock('@freecut/features/timeline/deps/export-contract', () => exportMocks)
vi.mock('@freecut/features/timeline/deps/media-library-resolver', () => mediaResolverMocks)
vi.mock('@freecut/features/timeline/utils/media-validation', () => mediaValidationMocks)
...
vi.mock('@freecut/shared/projects/migrations', () => ({
