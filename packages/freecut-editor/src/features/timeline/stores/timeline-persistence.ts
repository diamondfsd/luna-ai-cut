...
import type { CompositionEditorKind, ProjectTimeline, Project } from '@freecut/types/project'
...
import { getProject, updateProject, saveProjectThumbnail } from '@freecut/infrastructure/storage'
import {
  importCanvasRenderOrchestrator,
  convertTimelineToComposition,
} from '@freecut/features/timeline/deps/export-contract'
import { resolveMediaUrls } from '@freecut/features/timeline/deps/media-library-resolver'
import { importMediaLibraryService } from '@freecut/features/timeline/deps/media-library-service'
import { validateProjectMediaReferences } from '@freecut/features/timeline/utils/media-validation'
import { useMediaLibraryStore } from '@freecut/features/timeline/deps/media-library-store'
import { useSettingsStore } from '@freecut/features/timeline/deps/settings-contract'
import { migrateProject, CURRENT_SCHEMA_VERSION } from '@freecut/shared/projects/migrations'
import {
  needsLegacyAvTrackLayoutRepair,
  repairLegacyAvTrackLayout,
} from '@freecut/features/timeline/utils/legacy-av-track-repair'
import { splitUnpairedVideoAudio } from '@freecut/features/timeline/utils/embedded-audio-split'
import { getCompositionOwnedAudioSources } from '@freecut/features/timeline/utils/composition-clip-summary'
import {
