...
import { withPerfMeasure } from '@freecut/shared/logging/perf-marks'
import { emitDomainEvent } from '@freecut/shared/utils/domain-events'
...
import { isFrameInTransitionRegion } from '@freecut/features/timeline/deps/keyframes'
