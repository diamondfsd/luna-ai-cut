...
import { AppEyedropperOverlay, PropertyRow, SliderInput } from '@freecut/shared/ui/property-controls'
import { cn } from '@freecut/shared/ui/cn'
import { getEffectDefinitionName, getEffectParamLabel } from '@freecut/features/effects/utils/effect-i18n'
import {
  hueAmountFromWheelChannels,
  wheelChannelsFromHueAmount,
  type WheelChannels,
} from '@freecut/features/effects/utils/wheel-channels'
import {
  ...
  whitePointFromPick,
} from '@freecut/features/effects/utils/wheel-pickers'
...
import type { GpuEffectDefinition } from '@freecut/infrastructure/gpu-effects'
