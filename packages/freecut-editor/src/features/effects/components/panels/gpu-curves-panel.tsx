...
import { PropertyRow } from '@freecut/shared/ui/property-controls'
import { cn } from '@freecut/shared/ui/cn'
import { evaluateMonotoneCurve } from '@freecut/shared/utils/curve-spline'
import {
...
} from '@freecut/shared/utils/gpu-curves'
import type { GpuEffect } from '@freecut/types/effects'
import { getEffectDefinitionName } from '@freecut/features/effects/utils/effect-i18n'
