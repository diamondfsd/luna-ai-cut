...
import type { GpuEffect, ItemEffect } from '@freecut/types/effects'
...
vi.mock('@freecut/features/effects/deps/keyframes-contract', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@freecut/features/effects/deps/keyframes-contract')>()),
