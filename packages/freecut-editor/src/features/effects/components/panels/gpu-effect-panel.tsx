...
import { KeyframeToggle } from '@freecut/features/effects/deps/keyframes-contract'
import { ColorPicker, PropertyRow, SliderInput } from '@freecut/shared/ui/property-controls'
import {
  getEffectDefinitionName,
  getEffectOptionLabel,
  getEffectParamLabel,
} from '@freecut/features/effects/utils/effect-i18n'
import { getGpuEffectKeyframeValue } from '@freecut/features/effects/utils/effect-keyframes'
import {
  useGizmoStore,
  usePowerWindowEditorStore,
  useSpatialEffectEditorStore,
} from '@freecut/features/effects/deps/preview-contract'
import { getSpatialPointEffectConfig } from '@freecut/infrastructure/gpu-effects/spatial-point-editor'
