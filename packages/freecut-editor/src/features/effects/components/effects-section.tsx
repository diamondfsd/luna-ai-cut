...
import type { ItemEffect, GpuEffect, VisualEffect } from '@freecut/types/effects'
import { EFFECT_PRESETS } from '@freecut/types/effects'
import { useTimelineStore } from '@freecut/features/effects/deps/timeline-contract'
import {
  useGizmoStore,
  usePowerWindowEditorStore,
  useSpatialEffectEditorStore,
  useThrottledFrame,
} from '@freecut/features/effects/deps/preview-contract'
import { PropertySection } from '@freecut/shared/ui/property-controls'
import {
  GpuEffectPanel,
  GpuWheelsPanel,
  GpuCurvesPanel,
...
import { getGpuEffect, getGpuEffectDefaultParams } from '@freecut/infrastructure/gpu-effects'
...
import { getAutoKeyframeOperation } from '@freecut/features/effects/deps/keyframes-contract'
import { buildEffectAnimatableProperty, type AnimatableProperty } from '@freecut/types/keyframe'
import {
  getEffectCategoryLabel,
  getEffectDefinitionName,
} from '@freecut/features/effects/utils/effect-i18n'
import {
  getGpuEffectKeyframeProperty,
  getGpuEffectKeyframeValue,
  getResolvedGpuEffectForFrame,
} from '@freecut/features/effects/utils/effect-keyframes'
