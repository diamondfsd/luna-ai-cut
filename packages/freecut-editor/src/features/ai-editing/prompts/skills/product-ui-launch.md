...
description: Create an evidence-led product interface launch video from real screenshots or recordings. Use for UI redesigns, product prototypes, build-in-public updates, and requests to turn an interface into a finished short video.
---
...
- Every claim, crop, and highlighted region must be supported by analysed image or video evidence.
- Do not invent product behavior, labels, footage, or interface regions.
- Decide whether to preserve or replace existing timeline content from the user's request and the current project state.
