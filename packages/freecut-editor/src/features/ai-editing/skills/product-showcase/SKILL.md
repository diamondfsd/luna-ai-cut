...
1. Inspect the project and audit eligible image or video assets.
...
5. Decide whether the request is a new standalone video or an addition to the current edit. Use `replaceExisting: true` for a new video when prior content is unrelated; preserve it for an extension or revision.
