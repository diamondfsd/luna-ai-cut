...
1. Build a Production Blueprint before changing the timeline. Every shot must cite a real analysed image or video asset and a visible UI region.
2. Use four to six numbered shots: an immediate hook, focused UI proof, a timeline/detail proof, and a clear closing beat.
