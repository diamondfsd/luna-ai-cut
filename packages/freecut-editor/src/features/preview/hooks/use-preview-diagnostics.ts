...
let devJitterMonitor: import('@freecut/shared/logging/frame-jitter-monitor').FrameJitterMonitor | null =
  null
if (import.meta.env.DEV) {
  void import('@freecut/shared/logging/frame-jitter-monitor').then((module) => {
