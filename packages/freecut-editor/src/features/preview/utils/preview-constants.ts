...
export type PreviewPerfSnapshot = {
  ...
  preloadBatchAvgMs: number
    ...
    userPreviewQuality: import('@freecut/shared/state/playback').PreviewQuality
    adaptiveQualityCap: import('@freecut/shared/state/playback').PreviewQuality
    effectivePreviewQuality: import('@freecut/shared/state/playback').PreviewQuality
