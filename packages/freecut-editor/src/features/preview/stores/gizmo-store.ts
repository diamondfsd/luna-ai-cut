...
import type { ShapeItem, TimelineItem } from '@freecut/types/timeline'
import type { CropSettings } from '@freecut/types/transform'
...
export interface ItemPropertiesPreview extends Partial<Pick<ShapeItem, ShapePreviewProperty>> {
  ...
  // Text properties
  text?: string
  textSpans?: import('@freecut/types/timeline').TextSpan[]
  fontSize?: number
