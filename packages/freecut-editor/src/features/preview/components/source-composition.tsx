...
import { AbsoluteFill } from '@freecut/features/preview/deps/player-core'
import {
  useClock,
  useClockIsPlaying,
...
import { SharedVideoExtractorPool, type VideoFrameSource } from '@freecut/features/preview/deps/export'
...
import { useMediaLibraryStore } from '@freecut/features/preview/deps/media-library'
import { shouldSeekPlayingMedia } from '../utils/source-media-sync'
import { SourceAudioWaveform } from './source-audio-waveform'
import { LottieRenderer } from '@freecut/infrastructure/lottie/lottie-frame-provider'
