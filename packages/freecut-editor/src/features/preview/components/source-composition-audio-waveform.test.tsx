...
vi.mock('@freecut/features/preview/deps/player-core', () => ({
...
vi.mock('@freecut/features/preview/deps/player-pool', () => ({
...
vi.mock('@freecut/features/preview/deps/timeline-utils', () => ({
  useWaveform: () => ({
