...
import { Tooltip, TooltipTrigger, TooltipContent } from '@freecut/components/ui/tooltip'
import {
  getTrackKind,
  performInsertEdit,
  performOverwriteEdit,
  resolveSourceEditTrackTargets,
} from '@freecut/features/preview/deps/timeline-source-edit'
import {
  ...
  VideoConfigProvider,
  usePlayer,
} from '@freecut/features/preview/deps/player-context'
...
import { useMediaLibraryStore, getMediaType } from '@freecut/features/preview/deps/media-library'
import { useItemsStore } from '@freecut/features/preview/deps/timeline-store'
import { useSettingsStore } from '@freecut/features/preview/deps/settings'
import { useEditorStore } from '@freecut/shared/state/editor'
import { useSourcePlayerStore } from '@freecut/shared/state/source-player'
import { getNextShuttleRate } from '@freecut/shared/state/playback/shuttle'
...
import {
  ...
  IoRangeStrip,
  useMeasuredWidth,
} from '@freecut/shared/timeline/io-range'
import { formatTimecodeCompact } from '@freecut/shared/utils/time-utils'
