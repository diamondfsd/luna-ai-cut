...
vi.mock('@freecut/infrastructure/browser/blob-url-manager', async () => {
...
vi.mock('@freecut/features/preview/deps/player-core', async () => {
  const React = await import('react')
...
vi.mock('@freecut/features/preview/deps/composition-runtime', () => ({
