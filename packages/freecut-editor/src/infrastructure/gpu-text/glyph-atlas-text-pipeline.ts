...
import type { TextMotionSpec } from '@freecut/types/text-motion'
import { layoutTextBlock, lineInkWidth } from '@freecut/shared/typography/text-block-layout'
import { parseFontSizePx, type TextMeasurer } from '@freecut/shared/typography/text-measurer'
import {
  evaluateGlyphMotion,
...
} from '@freecut/shared/typography/text-motion'
