...
import { getProject } from '@freecut/infrastructure/storage/workspace-fs/projects'
import { getMedia } from '@freecut/infrastructure/storage/workspace-fs/media'
import { getThumbnailByMediaId } from '@freecut/infrastructure/storage/workspace-fs/thumbnails'
import { getTranscript } from '@freecut/infrastructure/storage/workspace-fs/transcripts'
import { getProjectMediaIds } from '@freecut/infrastructure/storage/workspace-fs/project-media'
import { getGifFrames } from '@freecut/infrastructure/storage/workspace-fs/gif-frames'
import { setWorkspaceRoot } from '@freecut/infrastructure/storage/workspace-fs/root'
import {
  asHandle,
  createRoot,
  readFileText,
  type MemDir,
} from '@freecut/infrastructure/storage/workspace-fs/__tests__/in-memory-handle'
