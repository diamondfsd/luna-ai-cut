...
import { readJson, removeEntry, writeJsonAtomic, listDirectory } from '../fs-primitives'
...
export async function deleteAiOutput(mediaId: string, kind: AiOutputKind): Promise<void> {
