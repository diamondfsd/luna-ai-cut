...
} from '@freecut/infrastructure/browser/object-url-registry'
import {
...
import { getWorkspaceRoot } from '@freecut/infrastructure/storage/workspace-fs/root'
import { ensureAc3DecoderRegistered, isAc3AudioCodec } from '@freecut/shared/utils/ac3-decoder'
import { createManagedWorker, type ManagedWorker } from '@freecut/shared/utils/managed-worker'
import type { DecodedPreviewAudioMeta, DecodedPreviewAudioBin } from '@freecut/types/storage'
import {
