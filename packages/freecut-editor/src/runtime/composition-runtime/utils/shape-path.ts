...
import { buildBezierPathData } from '@freecut/shared/graphics/shapes/bezier-path'
import {
  makeRect,
  makeCircle,
  makeTriangle,
  ...
  makePolygon,
  makeHeart,
} from '@freecut/shared/graphics/shapes/shape-generators'
import { scalePath, translatePath } from '@freecut/shared/graphics/shapes/path-utils'
