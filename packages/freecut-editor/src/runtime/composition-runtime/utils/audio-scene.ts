import type { AudioItem, VideoItem } from '@freecut/types/timeline'
...
import type { AudioClipFadeSpan } from '@freecut/shared/utils/audio-fade-curve'
import {
...
type StandaloneAudioItem = AudioItem & {
  ...
  trackAudioEq?: import('@freecut/types/audio').AudioEqSettings
