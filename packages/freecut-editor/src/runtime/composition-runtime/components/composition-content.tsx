...
import { useCompositionsStore } from '@freecut/runtime/composition-runtime/deps/stores'
import { blobUrlManager, useBlobUrlVersion } from '@freecut/infrastructure/browser/blob-url-manager'
import { VideoConfigProvider } from '@freecut/runtime/composition-runtime/deps/player'
import { useVideoConfig } from '../hooks/use-player-compat'
import { useGizmoStore } from '@freecut/runtime/composition-runtime/deps/stores'
import {
  mapSourceWindowOverlap,
  timelineToSourceFrames,
} from '@freecut/runtime/composition-runtime/deps/timeline'
import { hasKeyframeAnimation } from '@freecut/runtime/composition-runtime/deps/keyframes'
...
import { clearMixerLiveGain } from '@freecut/shared/state/mixer-live-gain'
import { appendResolvedAudioEqSources } from '@freecut/shared/utils/audio-eq'
...
import { getLinkedVideoIdsWithAudio, hasLinkedAudioCompanion } from '@freecut/shared/utils/linked-media'
import { resolveProxyUrl } from '@freecut/runtime/composition-runtime/deps/media-library'
import { loadFonts } from '../utils/fonts'
import { applyCompositionControlOverrides } from '@freecut/shared/utils/composition-controls'
