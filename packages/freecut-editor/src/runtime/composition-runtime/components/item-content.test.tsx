...
import type { CompositionItem, ControllerItem } from '@freecut/types/timeline'
import { ItemContent } from './item-content'

vi.mock('@freecut/runtime/composition-runtime/deps/player', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@freecut/runtime/composition-runtime/deps/player')>()),
