...
vi.mock('@freecut/runtime/composition-runtime/deps/player', () => ({
...
vi.mock('@freecut/runtime/composition-runtime/deps/stores', () => ({
...
vi.mock('@freecut/runtime/composition-runtime/deps/keyframes', () => ({
  getPropertyKeyframes: () => [],
  interpolatePropertyValue: (_keyframes: unknown, _frame: number, fallback: number) => fallback,
}))

vi.mock('@freecut/runtime/composition-runtime/utils/dom-video-element-registry', () => ({
