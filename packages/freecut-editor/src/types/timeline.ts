...
import type { TextStylePresetId } from '@freecut/shared/typography/text-style-preset-ids'
...
type BaseTimelineItem = {
  ...
  audioEqBand1Type?: import('@freecut/types/audio').AudioEqBand1Type
  ...
  audioEqLowType?: import('@freecut/types/audio').AudioEqInnerBandType
  ...
  audioEqLowMidType?: import('@freecut/types/audio').AudioEqInnerBandType
  ...
  audioEqHighMidType?: import('@freecut/types/audio').AudioEqInnerBandType
  ...
  audioEqHighType?: import('@freecut/types/audio').AudioEqInnerBandType
  ...
  audioEqBand6Type?: import('@freecut/types/audio').AudioEqBand6Type
  ...
  // render time (no baked keyframes). See @freecut/types/motion.
...
export type ShapeItem = BaseTimelineItem &
  ShapeStyleFields & {
    ...
    pathVertices?: import('@freecut/types/masks').MaskVertex[] // Normalized 0-1 vertices for 'path' shapeType
