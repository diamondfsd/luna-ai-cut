...
} from '@freecut/shared/projects/last-editor-project'
import './index.css'
...
if (import.meta.env.DEV) {
  void import('@freecut/app/debug').then(({ initializeDebugUtils }) => initializeDebugUtils())
}
...
async function saveCurrentProjectBeforeReload(): Promise<boolean> {
  ...
  try {
    const { useTimelineStore } = await import('@freecut/features/timeline/stores/timeline-store-facade')
