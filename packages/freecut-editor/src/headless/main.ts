...
import type { TimelineTrack, TimelineItem, TextItem } from '@freecut/types/timeline'
import type { Transition } from '@freecut/types/transition'
import type { ItemKeyframes } from '@freecut/types/keyframe'
import type { AudioEqSettings } from '@freecut/types/audio'
...
import { CURRENT_SCHEMA_VERSION, migrateProject } from '@freecut/shared/projects/migrations'
import type { ProjectWarning } from '@freecut/shared/projects/migrations'
import {
  DEFAULT_PROJECT_FPS,
  DEFAULT_PROJECT_HEIGHT,
  DEFAULT_PROJECT_WIDTH,
} from '@freecut/shared/projects/defaults'
import { validateProject } from '@freecut/features/project-bundle/schemas/project-schema'
import { mediaProcessorService } from '@freecut/features/media-library/services/media-processor-service'
import { getMimeType, validateMediaFileContent } from '@freecut/features/media-library/utils/validation'
import { convertTimelineToComposition } from '@freecut/features/export/utils/timeline-to-composition'
import {
  renderComposition,
  renderAudioOnly,
  renderSingleFrame,
} from '@freecut/features/export/utils/canvas-render-orchestrator'
import { getAnimatedTransform, buildKeyframesMap } from '@freecut/features/export/utils/canvas-keyframes'
import type { ClientExportSettings, RenderProgress } from '@freecut/features/export/utils/client-renderer'
import {
  getSupportedCodecs,
  selectFallbackVideoCodec,
  getPreferredContainerForCodec,
  getDefaultAudioCodec,
} from '@freecut/features/export/utils/client-renderer'
import type { ClientVideoContainer } from '@freecut/features/export/utils/client-renderer'
import { resolveMediaUrls } from '@freecut/features/media-library/utils/media-resolver'
import { blobUrlManager } from '@freecut/infrastructure/browser/blob-url-manager'
import {
  useCompositionsStore,
  type SubComposition,
} from '@freecut/features/export/deps/timeline-compositions'
...
import { hasAudioContent } from '@freecut/features/export/utils/canvas-audio'
import { ensureFontsLoaded } from '@freecut/shared/typography/font-loader'
import {
  collectVisibleTextFontFamilies,
  resolveTrackRenderState,
} from '@freecut/runtime/composition-runtime/utils/scene-assembly'
import { expandTextTransformToFitContent } from '@freecut/runtime/composition-runtime/utils/text-layout'
import { layoutTextBlock, lineInkWidth } from '@freecut/shared/typography/text-block-layout'
import { createCanvasTextMeasurer } from '@freecut/shared/typography/text-measurer'
import { resolveAnimatedTextItem } from '@freecut/features/keyframes/utils/animated-text-item'
