...
import { deleteCustomLut, listCustomLuts } from '../features/color/customLutLibraryService'
import {
...
export function register(ctx: IpcContext): void {
  ...
  ipcMain.handle('mock:start', (_event, deviceId?: string, s?: Partial<AppSettings>) => startMockServer(deviceId, s))
  ipcMain.handle('mock:stop', (_event, deviceId?: string) => stopMockServer(deviceId))
  ipcMain.handle('mock:status', (_event, deviceId?: string) => getMockServerStatus(deviceId))
  ipcMain.handle('mock:statuses', () => getMockServerStatuses())
