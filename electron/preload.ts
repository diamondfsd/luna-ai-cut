...
const lunaApi: LunaApi & { exportTask: LunaExportTaskApi } = {
  ...
  workspace: {
    ...
    segmentImage: (filePath: string, point?: { x: number; y: number }, modelId?: import('../src/shared/segmentationModels').SegmentationModelId, targetClassId?: number) => ipcRenderer.invoke('workspace:segmentImage', filePath, point, modelId, targetClassId),
