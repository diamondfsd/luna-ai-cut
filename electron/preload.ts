...
const lunaApi: LunaApi & { exportTask: LunaExportTaskApi } = {
  ...
  workspace: {
    ...
    getGenerativeRemovalCapability: () => ipcRenderer.invoke('workspace:getGenerativeRemovalCapability'),
    prepareGenerativeRemoval: (requestId: string) => ipcRenderer.invoke('workspace:prepareGenerativeRemoval', requestId),
