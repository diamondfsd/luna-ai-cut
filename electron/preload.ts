...
const lunaApi: LunaApi & { exportTask: LunaExportTaskApi } = {
  ...
  startFileDrag: (filePaths: string[]) => ipcRenderer.send('files:start-drag', filePaths),
  ...
  aiSelection: {
    ...
    deletePerson: (sessionId, groupId) => ipcRenderer.invoke('ai-selection:delete-person', sessionId, groupId),
