...
const lunaApi: LunaApi = {
  ...
  workspace: {
    ...
    exportFFmpeg: (sourcePath: string, pipeline: Record<string, unknown>, exportMeta: { exportId: string; taskName: string; taskId?: string }) => ipcRenderer.invoke('workspace:exportFFmpeg', sourcePath, pipeline, exportMeta),
