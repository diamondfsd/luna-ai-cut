...
const lunaApi: LunaApi & { exportTask: LunaExportTaskApi } = {
  ...
  freecutExport: {
    ...
    preserveSourceMetadata: (outputPath, sourcePath, options) => ipcRenderer.invoke('freecut-export:preserve-source-metadata', outputPath, sourcePath, options),
  ...
  workspace: {
    ...
    readSubtitleFontFile: (filePath: string) => ipcRenderer.invoke('workspace:readSubtitleFontFile', filePath),
