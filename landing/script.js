...
const LATEST_RELEASE = {
  tag: 'v1.8.2',
  label: 'v1.8.2',
  gitcode_mac_arm: 'https://gitcode.com/diamondfsd/luna-ai-cut-package-release/releases/download/v1.8.2/LunaAICut-Mac-1.8.2-Installer-arm64.dmg',
  gitcode_mac_x64: 'https://gitcode.com/diamondfsd/luna-ai-cut-package-release/releases/download/v1.8.2/LunaAICut-Mac-1.8.2-Installer-x64.dmg',
  gitcode_win: 'https://gitcode.com/diamondfsd/luna-ai-cut-package-release/releases/download/v1.8.2/LunaAICut-Windows-1.8.2-Setup-x64.exe',
}
