...
assert.equal(compatibility.releaseChannelForVersion('1.8.0-beta.1').releaseTag, 'v1.8.0-beta.1')
assert.equal(compatibility.releaseVersionFromTag('v1.8.0-beta.2').version, '1.8.0-beta.2')
assert.equal(compatibility.releaseVersionFromTag('v1.8.0').version, '1.8.0')
assert.equal(compatibility.releaseVersionFromTag('beta/v1.8.0-beta.2'), null)
assert.equal(compatibility.releaseVersionFromTag('test-beta-v1.8.0-beta.2'), null)
assert.equal(compatibility.releaseVersionFromTag('test-v1.8.0'), null)
assert.equal(compatibility.releaseVersionFromTag('test/beta/v1.8.0-beta.2'), null)
