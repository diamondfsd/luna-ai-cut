...
const REDUNDANT_VIDEO_METADATA_KEYS = new Set(['Make', 'Model', 'FirmwareVersion'])
...
function visibleMetadataEntries(name: string, entries: Array<{ key: string; value: string }>) {
