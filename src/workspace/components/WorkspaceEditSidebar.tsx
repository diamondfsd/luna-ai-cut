import { ArrowLeft, Check, Crop, Image, ImagePlus, Loader2, Paintbrush, RotateCcw, Scissors, SlidersHorizontal, Sparkles, X } from 'lucide-react'
...
export type WorkspaceTool = 'border' | 'color' | 'creative' | 'crop' | 'trim' | 'watermark' | 'filter' | 'mask'
