...

        {
            ...
            for layer in &sorted {
                ...
                let params = GpuLayerParams {
                    ...
                    fill_rgba,
                    stroke_rgba,
                    text_meta: [(layer.font_size.unwrap_or(16.0) * canvas_height as f64 / 1080.0) as f32, text_align, ascii.len() as f32, layer.reveal_progress.unwrap_or(1.0).clamp(0.0, 1.0) as f32],
                    text_data,
                    curve_data,
                    hsl_data,
                };
